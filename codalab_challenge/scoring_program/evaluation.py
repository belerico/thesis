...
language2column_task1 = {
    ("task1", "all"): "ACC_ALL",
    ("task1", "german"): "ACC_GERMAN",
    ("task1", "english"): "ACC_ENGLISH",
    ("task1", "latin"): "ACC_LATIN",
    ("task1", "swedish"): "ACC_SWEDISH",
}
language2column_task2 = {
    ("task2", "all"): "SPR_ALL",
    ("task2", "german"): "SPR_GERMAN",
    ("task2", "english"): "SPR_ENGLISH",
    ("task2", "latin"): "SPR_LATIN",
    ("task2", "swedish"): "SPR_SWEDISH",
}
...
for language in languages:
    ...
    if not os.path.exists(submission_path):
        ...
        sys.exit(
            message.format(submission_file_name, os.listdir(submission_dir))
        )
    ...
    if set(submission.keys()) != set(truth.keys()) or len(
        submission.keys()
    ) != len(truth.keys()):
        message = (
            "Error in '{0}': Submitted targets do not match gold targets."
        )
